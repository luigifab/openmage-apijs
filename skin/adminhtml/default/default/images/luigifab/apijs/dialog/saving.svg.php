...
<svg width="<?php echo $width ?>" height="<?php echo $height ?>" xmlns="http://www.w3.org/2000/svg" version="1.1">
	...
	<circle cx="50%" cy="50%" r="40%" stroke="#222" stroke-opacity="0" fill="none" stroke-width="10%">
		<animate attributeName="r" dur="0.9s" begin="0.3s;a.end+0.7s" from="2%" to="40%" id="a" />
		<animate attributeName="stroke-opacity" dur="0.9s" begin="0.3s;b.end+0.7s" from="1" to="0" id="b" />
	</circle>
	<circle cx="50%" cy="50%" r="40%" stroke="#222" stroke-opacity="0" fill="none" stroke-width="10%">
		<animate attributeName="r" dur="0.9s" begin="0.75s;c.end+0.7s" from="2%" to="40%" id="c" />
		<animate attributeName="stroke-opacity" dur="0.9s" begin="0.75s;d.end+0.7s" from="1" to="0" id="d" />
	</circle>
</svg>