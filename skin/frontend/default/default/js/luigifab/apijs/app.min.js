...
filename=filename.slice(filename.lastIndexOf('\\')+1);text=(this.extensions.length<1)?apijs.i18n.translate('uploadBadOneType',filename,last):apijs.i18n.translate('uploadBadMultiType',filename,this.extensions.slice(0,-1).join(', '),last);this.showRetry(text,input.getAttribute('name'));}
