...
$opacityStart = ((strpos($_SERVER['HTTP_USER_AGENT'], 'Opera') !== false) || (strpos($_SERVER['HTTP_USER_AGENT'], 'MSIE') !== false)) ? 1 : 0;
...
<svg width="<?php echo $width ?>" height="<?php echo $height ?>" xmlns="http://www.w3.org/2000/svg" version="1.1">
	<g transform="rotate(-20, <?php echo intval(intval($width) / 2) ?>, <?php echo intval(intval($height) / 2) ?>)">
		<g font-family="Verdana, sans-serif" font-weight="bold" fill="black" fill-opacity="<?php echo $opacityStart ?>">
		...
		<g opacity="<?php echo $opacityStart ?>">
